...
⚠️ Остават 8 червени теста на main, всичките ПРЕДИ тази работа:
agent-routes, document-pdf, orders-quotation, payments-razpiska (2),
permissions-registry-route, products-search-order (2).
