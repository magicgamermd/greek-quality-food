...
## Без страници в списъците — 2026-08-03 (PR #91, ЖИВО)

Списъците се показват ИЗЦЯЛО на екрана: Продукти, Партньори, Склад,
Доставчици. Бутоните Назад/Напред отпадат; футърът отчита броя.
